class UserStepsCoachController < ApplicationController
  include BlitzHelper
  ...
  def update
    ...
    @user.blitz_roles.push('coach') unless @user.blitz_roles.include?('coach') or @user.blitz_roles.include?('Coach')
