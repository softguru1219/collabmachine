...
class SoftwaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create software" do
    assert_difference('Software.count') do
      post softwares_url, params: { software: { abr: @software.abr, name: @software.name, number: @software.number } }
    end
  ...
  test "should update software" do
    patch software_url(@software), params: { software: { abr: @software.abr, name: @software.name, number: @software.number } }
